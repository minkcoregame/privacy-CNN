...
try:
    while True:
        ...
        print('show image')
        img_get_filename = '/Users/suksomboon/Desktop/photo/Img_client.jpg'
        ...
        if Flag:
            img_put_filename = '/Users/suksomboon/Desktop/photo/nikola-tesla.jpg'

            new_data = cv2.imread(img_put_filename, 0)
